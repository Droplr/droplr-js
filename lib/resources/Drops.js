...
class Drops extends AbstractResource {
  ...
  create(data, options = {}) {
    ...
    if (data.type === 'FILE') {
      ...
      if (data.width) localOptions.params.width = data.width;
      if (data.height) localOptions.params.height = data.height;
      if (data.isGif) localOptions.params.isGif = data.isGif;
